...
function dataStruct = load_data(filename)
    % Read a CSV file with at least two columns: name and value.
    % Values can be numbers, vectors, ranges, linspace expressions, or strings.
    % Variables are created in the caller workspace and also returned as a struct.
